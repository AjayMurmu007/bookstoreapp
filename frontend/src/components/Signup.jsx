    ...
    return (
        <>
            <div className='flex h-screen items-center justify-center'>
                <div className="w-[600px] dark:text-black">
                    <div className="modal-box">
                        <form onSubmit={handleSubmit(onSubmit)} method="dialog">
                            ...
                            <div className='mt-5 space-y-2'>
                                <span>Name</span>
                                <br />
                                <input type='text' placeholder='Enter your fullname' className='w-80 px-3 py-1 rounded-md outline-none' {...register("fullname", { required: true })}></input>
                                <br />
                            ...
                            <div className='flex justify-around mt-4'>
                                ...
                                <p className='text-xl'>Have account <button className='underline text-blue-500 cursor-pointer' onClick={() => document.getElementById("my_modal_3").showModal()}>Login</button></p> <Login />
                            </div>
                        </form>
